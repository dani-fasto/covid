  ...
  <body>
          ...
          if(request.getParameter("submit")!=null)
    {
     ...
     URI dbUri = new URI(System.getenv("DATABASE_URL"));
                      ...
                      String username_heroku = dbUri.getUserInfo().split(":")[0];
                      String password_heroku = dbUri.getUserInfo().split(":")[1];
     ...
     con=DriverManager.getConnection(dbUrl,username_heroku,password_heroku );
     pst=con.prepareStatement("update public.covid_stat set  infection=?, healing=? ,death=? where id=1 ");
            ...
            <form action="" method="post">
              ...
              <div class="row">
                  <% 
                    ...
                    String query = "select * from public.covid_stat";
